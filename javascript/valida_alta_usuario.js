...
function validaFormUsuario(){
    ...
    var tipo_usuario = document.getElementById("tipo_user").selectedIndex;
        ...
        else if(tipo_usuario == null || tipo_usuario.length == 0 || tipo_usuario == "0")
        {
            alert("Olvidaste seleccionar el tipo de usuario");
            document.getElementById("tipo_user").style.background="pink";
            document.getElementById("tipo_user").focus();
            return false;
        }   
        return true;
    }
